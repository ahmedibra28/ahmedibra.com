---
    ...
    - 'golang'
    image: "/golang-fist-time.png"
    keywords: "Golang, web development, full-stack developer, secondary language, complementary language, programming languages, learning journey, resources, challenges, tips"
