...
export default function Skills() {
  ...
  return (
    <div
      ...
      id='skills'
    >
      <h2 className='text-center text-3xl font-bold sm:text-5xl uppercase text-secondary mb-4 mt-5 sm:mt-0'>
        The Tech I use
      </h2>
        ...
        <div className='w-full lg:w-1/3 sm:mr-7'>
          ...
          <ul className='flex flex-wrap'>
            {frontend.map((skill) => (
              <li
                key={skill.name}
                className='rounded-2xl flex items-center p-2 mb-3 hover:text-primary hover:border-primary hover:animate-pulse shadow-sm shadow-primary w-[45%] mx-auto bg-white duration-1000'
              >
